package florinl.licenta.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, florinl.licenta.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, florinl.licenta.repository.UserRepository.USERS_BY_EMAIL_CACHE);
